...
class SoundTestMenu extends MusicBeatState
{
	...
	{
		if (first == 10 && second == 9)
			{
				woahmanstopspammin = false;
				PlayStateChangeables.nocheese = false;
				PlayState.SONG = Song.loadFromJson('kaboom', 'kaboom');
		...
		else if (first == 6 && second == 23) // swizik added stuff starts HERE!
			{
				...
				new FlxTimer().start(2.1, function(tmr:FlxTimer)
				{
                	video.playMP4(Paths.video('tangy8alt2'));
					incameo = true;
				});
			}
		else if (first == 11 && second == 30) // swizik added stuff starts HERE!
			{
				var video:MP4Handler = new MP4Handler();
				woahmanstopspammin = false;
				flashyWashy(true);
				...
				new FlxTimer().start(2.1, function(tmr:FlxTimer)
				{
                	video.playMP4(Paths.video('LemmySS_'));
					incameo = true;
				});
			}
		else if (first == 60 && second == 15) // swizik added stuff starts HERE!
			{
				var video:MP4Handler = new MP4Handler();
				woahmanstopspammin = false;
				flashyWashy(true);
				...
				new FlxTimer().start(2.1, function(tmr:FlxTimer)
				{
                	video.playMP4(Paths.video('BlueIsADude'));
					incameo = true;
				});
			}
		else if (first == 2 && second == 18) // swizik added stuff starts HERE!
			{
				var video:MP4Handler = new MP4Handler();
				woahmanstopspammin = false;
				flashyWashy(true);
				...
				new FlxTimer().start(2.1, function(tmr:FlxTimer)
				{
                	video.playMP4(Paths.video('BugCitrus'));
					incameo = true;
				});
			}
		else if (first == 11 && second == 2) // swizik added stuff starts HERE!
			{
				var video:MP4Handler = new MP4Handler();
				woahmanstopspammin = false;
				flashyWashy(true);
				...
				new FlxTimer().start(2.1, function(tmr:FlxTimer)
				{
                	video.playMP4(Paths.video('JackyChang64'));
					incameo = true;
				});
			}
		else if (first == 4 && second == 10) // swizik added stuff starts HERE!
			{
				var video:MP4Handler = new MP4Handler();
				woahmanstopspammin = false;
				flashyWashy(true);
				...
				new FlxTimer().start(2.1, function(tmr:FlxTimer)
				{
                	video.playMP4(Paths.video('Plaserd'));
					incameo = true;
				});
			}
		else if (first == 19 && second == 8) // swizik added stuff starts HERE!
			{
				var video:MP4Handler = new MP4Handler();
				woahmanstopspammin = false;
				flashyWashy(true);
				...
				new FlxTimer().start(2.1, function(tmr:FlxTimer)
				{
                	video.playMP4(Paths.video('EggBorb'));
					incameo = true;
				});
			}
		else if (first == 56 && second == 6) // swizik added stuff starts HERE!
			{
				woahmanstopspammin = false;
				flashyWashy(true);
				new FlxTimer().start(2, function(tmr:FlxTimer)
				{
					cameoImg.visible = true;
					cameoImg.loadGraphic(Paths.image('cameostuff/MoonThinks4Once'));
					cameoImg.setSize(1280, 720);
					flashyWashy(false);
					FlxG.sound.music.stop();
				...
				new FlxTimer().start(2.1, function(tmr:FlxTimer)
				{
					FlxG.sound.playMusic(Paths.music('cameostuff/MoonThinks4Once'));	
					incameo = true;
				});
			}
		else if (first == 4 && second == 1) // swizik added stuff starts HERE!
			{
				woahmanstopspammin = false;
				flashyWashy(true);
				new FlxTimer().start(2, function(tmr:FlxTimer)
				{
					cameoImg.visible = true;
					cameoImg.loadGraphic(Paths.image('credits'));
					cameoImg.setSize(1280, 720);
					flashyWashy(false);
					FlxG.sound.music.stop();
				});
				new FlxTimer().start(2.1, function(tmr:FlxTimer)
				{
					FlxG.sound.playMusic(Paths.music('cameostuff/credits'));	
					incameo = true;
				});
			}
		else
